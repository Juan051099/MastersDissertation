  ...
  subroutine SortVertCell(center, vorcell)
    ...
    if ( vorcell%flag ) then
       ...
       if ( visible( vorcell%v(1:2,2), vorcell%v(1:2,1), vorcell%v(1:2,vorcell%n) ) ) then
          ...
          do ve=2,vorcell%n-1                      ! Modification added in april 25 2024. Originally ve=2, vorcell%n       
          ...
          angles(vorcell%n - 1) = 0.0d0            ! Modification added in april 25 2024.
          angles_sorted = angles
          ! Sort the angles.
          call quicksort(angles_sorted, vorcell%n - 1, 1, vorcell%n - 1)
          do vj = 2,vorcell%n
          ...
          angles(1)=0.0d0                    ! Modification added in april 25 2024. 
          do ve=2,vorcell%n - 1              ! Modification added in april 25 2024. Originally ve=1, vorcell%n - 1
             ! Sort from the angle in radians swept out between the rays 
